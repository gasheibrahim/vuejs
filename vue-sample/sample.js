new Vue({
  ...
  methods: {
    addStudent: function() {
      let lastid = this.students[this.students.length-1];
        let newid = lastid.id + 1;
      return this.students.push({id:newid, name: this.name, course: this.course, acceptancePeriod:this.acceptancePeriod})
    }
  }
})